...
import fr.com.jfish.sleepersrv.constants.GameConst;
 ...
 * @author thw
 */
public class AsteroidLowPoly extends AbstractAsset {
    ...
    public AsteroidLowPoly(final OpenGLGame game, final Camera camera, final FrustumIntersection frustumIntersection,
        ...
        this.scale = (float) ((Math.random() * 0.5 + 0.5) * AsteroidLowPoly.MAX_RADIUS);
