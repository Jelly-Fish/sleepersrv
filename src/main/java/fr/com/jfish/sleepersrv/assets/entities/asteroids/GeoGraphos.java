 ...
 * @author thw
 */
public class GeoGraphos extends AbstractAsset {
    ...
    public GeoGraphos(final OpenGLGame game, final Camera camera, final FrustumIntersection frustumIntersection,
        ...
        try {
            this.mesh = loader.loadMesh(FileConst.RES + FileConst.MDLS + "geographos.obj.zip");
