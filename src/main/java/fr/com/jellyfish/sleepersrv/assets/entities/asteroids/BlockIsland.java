 ...
 * @author thw
 */
public class BlockIsland extends AbstractAsset {
    ...
    public BlockIsland(final OpenGLGame game, final Camera camera, final FrustumIntersection frustumIntersection,
